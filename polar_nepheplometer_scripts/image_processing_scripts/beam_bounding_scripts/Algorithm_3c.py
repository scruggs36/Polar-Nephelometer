from Neph_Functions import Loop_Image_Average, Perp_Profiles, Image_Subtract, Image_Heatmaps, Profiles, Curve_Fit_Profiles, gaussian, quadratic, linear, loop_simps_riemann
...
'''
This code averages images in a directory and then evaluates the averaged image between the rows given in the initial boundaries section
'''
...
Path_ParticleDir = '/home/austen/media/winshare/Groups/Smith_G/Austen/Projects/Nephelometry/Polar Nephelometer/Data/06-08-2018/PSL_701nm/30s'
Path_MediumImage = '/home/austen/media/winshare/Groups/Smith_G/Austen/Projects/Nephelometry/Polar Nephelometer/Data/06-08-2018/N2_Analysis/im_avg_N2_30s.png'
Path_PF = '/home/austen/Documents/SD2_30s.txt'
...
z, tt_coords, tb_coords, ts, BES, PES, x_pts, y_pts = Perp_Profiles(im_Avg, tt_smooth, tb_smooth, cols_DF, numcols)
