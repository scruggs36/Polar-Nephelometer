...
Path_Samp_Dir = '/home/austen/media/winshare/Groups/Smith_G/Austen/Projects/Nephelometry/Polar Nephelometer/Data/02-13-2019/600nm_PSL/5s'
Path_N2_Dir = '/home/austen/media/winshare/Groups/Smith_G/Austen/Projects/Nephelometry/Polar Nephelometer/Data/02-13-2019/N2/T2/5s'
Path_He_Dir = '/home/austen/media/winshare/Groups/Smith_G/Austen/Projects/Nephelometry/Polar Nephelometer/Data/02-13-2019/He/5s'
Path_BKG_Dir = '/home/austen/media/winshare/Groups/Smith_G/Austen/Projects/Nephelometry/Polar Nephelometer/Data/02-13-2019/BKG/5s'
...
ax7[0].plot(cols_array, SD_Samp, linestyle='-', color='black', label='Raw 900nm PSL Scattering')
ax7[0].plot(cols_array, SD_N2, linestyle='-', color='green', label='N2 Scattering')
ax7[0].plot(cols_array, SD_He, linestyle='-', color='cyan', label='He Scattering')
ax7[0].plot(cols_array, SD_BKG, linestyle='-', color='red', label='Background Scattering')
ax7[1].semilogy(cols_array, SD_Samp, linestyle='-', color='black', label='Raw 900nm PSL Scattering')
ax7[1].semilogy(cols_array, SD_N2, linestyle='-', color='green', label='N2 Scattering')
ax7[1].semilogy(cols_array, SD_He, linestyle='-', color='cyan', label='He Scattering')
ax7[1].semilogy(cols_array, SD_BKG, linestyle='-', color='red', label='Background Scattering')
